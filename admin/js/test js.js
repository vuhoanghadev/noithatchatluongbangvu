const products = [
  {
    id: 56,
    name: 'Tủ Quần Áo QA560 - 5 Cánh Mở, 3 Ngăn Kéo, Vân Gỗ Sồi Tự Nhiên',
    category: 'Tủ Quần Áo',
    ...
    promotion: 'Ưu đãi đặc biệt tháng 5',
    tag: 'Mới',
    rating: 4.9,
    views: 850,
    soldCount: 75,
    promoEndDate: '2025-05-31T00:00:00',
    sku: 'NTBV-QA560',
    flashsale: {
      active: true,
      discountPercent: 25,
    ...
    specifications: {
      'Kích thước': '180x200x60cm (Rộng x Cao x Sâu)',
      'Chất liệu': 'Gỗ MDF phủ melamine vân gỗ sồi',
      'Màu sắc': 'Vân gỗ sồi tự nhiên',
      'Số cánh': '5 cánh mở',
      'Ngăn kéo': '3 ngăn kéo',
      'Tính năng đặc biệt':
    ...
    reviews: [
      {
        ...
        rating: 5,
        content: `Tủ quần áo đẹp và chắc chắn, đúng với mô tả. Giao hàng nhanh và lắp đặt tận tình. Tôi rất hài lòng với sản phẩm này!`,
        images: [
          'images/products/product1.png',
          'images/products/product2.png',
        ],
      ...
      },
      {
        ...
        date: '05/05/2025 10:45 AM',
        rating: 4.5,
        content: `Tủ đẹp, chất lượng tốt, màu sắc đúng như hình. Tuy nhiên thời gian giao hàng hơi lâu. Nhưng nhìn chung tôi vẫn rất hài lòng với sản phẩm.`,
        ...
        replies: [
          {
            author: 'Nội Thất Bàng Vũ',
            isAdmin: true,
            date: '06/05/2025 09:00 AM',
            content: `Cảm ơn chị đã phản hồi. Chúng tôi xin lỗi về sự chậm trễ trong quá trình giao hàng. Chúng tôi sẽ cải thiện dịch vụ trong thời gian tới.`,
            avatar: '../images/logo.svg',
          },
        ],
      },
