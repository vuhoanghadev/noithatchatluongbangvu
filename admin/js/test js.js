const products = [
    {
      ...
      specifications: {
        ...
        ĐIỂM NỔI BẬT: 'Thiết kế 4 cánh mở rộng rãi, 2 hàng ngăn kéo tiện lợi, Ô hở bên trái, Chất liệu nhựa Đài Loan bền chắc, Chống ẩm mốc, Chống cong vênh, Màu vân óc chó sang trọng',
      },
      detailedDescription: {
      ...
      reviews: [
        {
          ...
          rating: 5,
          content: `Sản phẩm rất đẹp và chắc chắn, đúng với mô tả. Giao hàng nhanh và lắp đặt tận tình. Tôi rất hài lòng với tủ quần áo này!`,
          images: [
            'images/products/product1.png',
            'images/products/product2.png'
          ],
          ...
          replies: [
            {
              ...
              content: `Cảm ơn anh đã tin tưởng và ủng hộ sản phẩm của chúng tôi. Chúc anh và gia đình có trải nghiệm tuyệt vời với sản phẩm!`,
        ...
        },
        {
          ...
          rating: 4.5,
          content: `Tủ đẹp, chất lượng tốt. Tuy nhiên thời gian giao hàng hơi lâu. Nhưng nhìn chung tôi vẫn rất hài lòng với sản phẩm.`,
          images: [
            'images/products/product3.png',
            'images/products/product4.png',
          ...
          replies: [
            {
              ...
              content: `Cảm ơn anh đã phản hồi. Chúng tôi xin lỗi về sự chậm trễ trong quá trình giao hàng. Chúng tôi sẽ cải thiện dịch vụ trong thời gian tới.`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 5,
          content: `Đậu xanh sản phẩm gì vừa đẹp vừa chất lượng, đúng với giá tiền. Tuy nhiên có một vài vết xước nhỏ khi giao hàng.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              isAdmin: true,
              date: '10/04/2025 09:15 AM',
              content: `Cảm ơn anh/chị đã tin tưởng và ủng hộ sản phẩm của shop! 😊 Shop rất vui khi anh/chị đánh giá cao về chất lượng và thiết kế đẹp của sản phẩm đậu xanh. Về vấn đề một vài vết xước nhỏ khi giao hàng, shop thành thật xin lỗi vì sự bất tiện này. Shop sẽ cố gắng cải thiện dịch vụ giao hàng trong thời gian tới.`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          date: '05/02/2025 08:15 PM',
          rating: 5,
          content: `Tủ quần áo thiết kế hiện đại, màu sắc sang trọng, giá cả rất hợp lý. Chỉ hơi tiếc là có vài vết xước nhỏ trên cánh tủ khi nhận.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              isAdmin: true,
              date: '10/04/2025 09:15 AM',
              content: `Cảm ơn anh/chị đã ủng hộ shop! 🌟 Shop xin lỗi về vết xước nhỏ. Vui lòng gửi ảnh qua Zalo 0972774646 để shop hỗ trợ sửa chữa ngay ạ!`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 5,
          content: `Tủ quần áo chất liệu nhựa giả gỗ đẹp, chắc chắn, giá tốt. Nhưng bao bì giao hàng hơi móp méo, may là tủ không bị ảnh hưởng nhiều.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              content: `Cảm ơn anh/chị đã tin tưởng shop! 😊 Shop xin lỗi vì bao bì chưa tốt. Shop sẽ kiểm tra lại vận chuyển để cải thiện. Có cần hỗ trợ thêm, anh/chị nhắn shop nhé!`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 4,
          content: `Tủ quần áo rộng rãi, nhiều ngăn tiện lợi, đúng như mô tả. Có điều lắp ráp hơi mất thời gian vì thiếu 1-2 con ốc nhỏ.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              content: `Cảm ơn anh/chị đã chọn sản phẩm shop! 🌼 Shop xin lỗi vì thiếu ốc. Anh/chị nhắn Zalo 0972774646, shop gửi bổ sung ngay ạ!`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 5,
          content: `Tủ quần áo đẹp, chất lượng vượt mong đợi, giá rất ổn. Giao hàng đúng hẹn, chỉ có một vết xước nhẹ ở góc tủ.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              content: `Cảm ơn anh/chị đã yêu thích sản phẩm! 😍 Shop xin lỗi về vết xước. Vui lòng gửi ảnh qua Fanpage để shop khắc phục nhanh nhé!`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 5,
          content: `Tủ quần áo thiết kế tối giản, phù hợp không gian nhỏ, giá hợp lý. Nhưng giao hàng chậm hơn dự kiến 1 ngày.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              content: `Cảm ơn anh/chị đã ủng hộ! 🌈 Shop xin lỗi vì giao hàng chậm. Shop sẽ phối hợp vận chuyển để cải thiện. Cần hỗ trợ, anh/chị liên hệ shop nhé!`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 4,
          content: `Tủ quần áo màu trắng đẹp, chất liệu bền, giá cả phải chăng. Chỉ hơi tiếc là hướng dẫn lắp ráp hơi khó hiểu.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              content: `Cảm ơn anh/chị đã chọn shop! 😊 Shop xin lỗi vì hướng dẫn chưa rõ. Anh/chị nhắn Zalo, shop gửi video hướng dẫn chi tiết ngay ạ!`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 4,
          content: `Tủ quần áo chắc chắn, thiết kế đẹp, phù hợp với phòng ngủ hiện đại. Có vài vết bẩn nhỏ trên bề mặt khi nhận hàng.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              content: `Cảm ơn anh/chị đã tin tưởng shop! 🌟 Shop xin lỗi về vết bẩn. Vui lòng gửi ảnh qua Zalo 0972774646 để shop hỗ trợ vệ sinh hoặc đổi mới ạ!`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 5,
          content: `Tủ quần áo rất đẹp, chất liệu tốt, giá hợp túi tiền. Giao hàng nhanh, nhưng đóng gói hơi lỏng lẻo.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              content: `Cảm ơn anh/chị đã yêu thích tủ! 😍 Shop xin lỗi vì đóng gói chưa tốt. Shop sẽ kiểm tra lại để cải thiện. Cần hỗ trợ, anh/chị nhắn shop nhé!`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 5,
          content: `Tủ quần áo thiết kế tinh tế, nhiều ngăn tiện dụng, giá ổn. Nhưng có một bản lề hơi lỏng sau khi lắp.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              content: `Cảm ơn anh/chị đã ủng hộ! 🌼 Shop xin lỗi vì bản lề. Anh/chị gửi ảnh qua Fanpage, shop hỗ trợ thay mới ngay ạ!`,
              avatar: '../images/logo.svg',
            }
          ],
        },
        {
          ...
          rating: 5,
          content: `Tủ quần áo đẹp, chất liệu nhựa cao cấp, giá hợp lý. Chỉ hơi bất tiện vì giao hàng trễ giờ hẹn.`,
          images: [],
          videos: [],
          isAnonymous: true,
          avatar: '',
          replies: [
            {
              ...
              content: `Cảm ơn anh/chị đã chọn shop! 🌈 Shop xin lỗi vì giao trễ. Shop sẽ cải thiện lịch trình vận chuyển. Cần hỗ trợ, anh/chị liên hệ shop nhé!`,
              avatar: '../images/logo.svg',
            }
          ],
        }
      ...
      policies: {
        shipping: 'Miễn phí vận chuyển trong phạm vi 10km từ cửa hàng. Phí vận chuyển sẽ được tính dựa trên khoảng cách và khối lượng sản phẩm cho các khu vực khác.',
        returns: 'Quý khách có thể đổi trả sản phẩm trong vòng 7 ngày kể từ ngày nhận hàng nếu sản phẩm có lỗi từ nhà sản xuất. Sản phẩm đổi trả phải còn nguyên vẹn, không có dấu hiệu đã qua sử dụng.',
        warranty: 'Sản phẩm được bảo hành chính hãng 10 năm cho các lỗi kỹ thuật. Bảo hành không áp dụng cho các trường hợp hư hỏng do sử dụng không đúng cách hoặc tự ý sửa chữa.',
        payment: 'Chúng tôi chấp nhận thanh toán bằng tiền mặt, chuyển khoản ngân hàng, thẻ tín dụng/ghi nợ và các ví điện tử phổ biến như MoMo, ZaloPay.',
      },
      care: {
        cleaning: 'Lau chùi sản phẩm thường xuyên bằng khăn mềm, khô hoặc hơi ẩm. Tránh sử dụng các chất tẩy rửa có tính axit hoặc kiềm mạnh.',
        sunlight: 'Không đặt sản phẩm dưới ánh nắng mặt trời trực tiếp trong thời gian dài để tránh bạc màu và biến dạng.',
        humidity: 'Không đặt sản phẩm ở nơi có độ ẩm cao hoặc tiếp xúc trực tiếp với nước để tránh gỗ bị cong vênh, nấm mốc.',
        temperature: 'Duy trì sản phẩm ở nhiệt độ phòng ổn định, tránh thay đổi nhiệt độ đột ngột có thể gây nứt, cong vênh.',
        tips: [
    ...
    },
    {
      ...
      price: '5.500.000đ',
      description: 'Bàn trang điểm gỗ tự nhiên được chế tác từ gỗ sồi cao cấp, mang lại vẻ đẹp sang trọng và tinh tế cho phòng ngủ. Với thiết kế hiện đại, bàn đi kèm gương lớn và các ngăn kéo, kệ lưu trữ rộng rãi, phù hợp để sắp xếp mỹ phẩm, phụ kiện và đồ dùng cá nhân. Bề mặt gỗ được phủ lớp sơn PU cao cấp, chống thấm nước, chống mối mọt và chống trầy xước, đảm bảo độ bền lâu dài. Kích thước bàn phù hợp với nhiều không gian phòng ngủ, từ căn hộ nhỏ đến nhà phố lớn, mang lại sự tiện nghi và thẩm mỹ.',
      size: '85x40x130cm',
      gallery: [
        'images/products/product5.png'
      ],
    ...
    },
    {
      ...
      category: 'Bàn Học',
      image: 'images/products/product3.png',
      description: 'Bàn học gỗ tự nhiên được chế tác từ gỗ sồi cao cấp, mang lại vẻ đẹp sang trọng và bền bỉ cho không gian học tập. Với thiết kế rộng rãi, bàn cung cấp không gian lưu trữ lớn cho sách vở, tài liệu và dụng cụ học tập. Bề mặt gỗ được phủ lớp sơn PU cao cấp, chống thấm nước, chống mối mọt và chống trầy xước, đảm bảo độ bền lâu dài. Màu gỗ tự nhiên ấm áp, kích thích sự tập trung khi học tập. Kích thước bàn phù hợp với các phòng học vừa và lớn, mang lại sự thoải mái và hiệu quả khi sử dụng.',
      size: '110x55x75cm',
    ...
    },
    {
      ...
      category: 'Bàn Làm Việc',
      image: 'images/products/product4.png',
      description: 'Bàn làm việc gỗ tự nhiên được chế tác từ gỗ sồi cao cấp, mang lại vẻ đẹp tinh tế và sang trọng cho không gian làm việc. Với thiết kế hiện đại, bàn cung cấp không gian lưu trữ lớn cho tài liệu, thiết bị văn phòng và vật dụng cá nhân. Bề mặt gỗ được phủ lớp sơn PU cao cấp, chống thấm nước, chống mối mọt và chống trầy xước, đảm bảo độ bền lâu dài. Màu gỗ tự nhiên ấm áp, dễ dàng kết hợp với nhiều phong cách nội thất. Kích thước bàn phù hợp với các văn phòng tại nhà hoặc văn phòng chuyên nghiệp, mang lại sự tiện nghi và hiệu quả khi làm việc.',
      size: '130x60x75cm',
      gallery: [
        'images/products/product4.png'
      ],
    },
    {
      ...
      category: 'Bàn Học',
      image: 'images/products/product3.png',
      description: 'Bàn học gỗ công nghiệp được thiết kế dành riêng cho học sinh và sinh viên với phong cách tối giản và tiện dụng. Sản phẩm được làm từ gỗ MDF phủ melamine cao cấp, mang lại độ bền cao và khả năng chống trầy xước. Thiết kế nhỏ gọn với các ngăn kéo và kệ lưu trữ, giúp sắp xếp sách vở, tài liệu và dụng cụ học tập một cách ngăn nắp. Màu sắc vân gỗ tự nhiên tạo cảm giác ấm áp, kích thích sự tập trung khi học tập. Kích thước bàn phù hợp với các phòng học nhỏ, đảm bảo sự thoải mái khi sử dụng trong thời gian dài.',
      size: '95x50x70cm',
      promotion: 'sale 15%',
      gallery: [
        'images/products/product3.png',
    ...
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ MDF được chế tác từ gỗ công nghiệp phủ melamine cao cấp, mang lại vẻ đẹp hiện đại và tiện dụng cho phòng ngủ. Với thiết kế tối giản, giường có các đường nét tinh tế, phù hợp với nhiều phong cách nội thất từ hiện đại đến tối giản. Bề mặt gỗ được xử lý kỹ lưỡng, chống thấm nước và chống trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, mang lại sự thoải mái tối đa cho giấc ngủ. Sản phẩm này là lựa chọn lý tưởng cho những ai yêu thích sự tiện nghi và thẩm mỹ trong không gian phòng ngủ.',
      size: '160x200cm',
      promotion: 'sale 20%',
      gallery: [
        'images/products/product8.png',
    ...
    },
    {
      ...
      category: 'Tủ Sách',
      image: 'images/products/product7.png',
      description: 'Tủ sách gỗ tự nhiên được chế tác từ gỗ sồi cao cấp, mang lại vẻ đẹp sang trọng và đẳng cấp cho không gian sống. Với thiết kế các kệ mở và ngăn kéo tích hợp, tủ cung cấp không gian lưu trữ lớn cho sách, tài liệu, đồ trang trí hoặc các vật dụng cá nhân. Bề mặt gỗ được phủ lớp sơn PU cao cấp, chống thấm nước, chống mối mọt và chống trầy xước, đảm bảo độ bền lâu dài. Màu gỗ tự nhiên ấm áp, dễ dàng kết hợp với nhiều phong cách nội thất. Kích thước tủ phù hợp với phòng khách, phòng làm việc hoặc phòng ngủ lớn.',
      size: '120x30x200cm',
      gallery: [
        'images/products/product7.png',
        'images/products/product8.png'
    ...
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên tối giản hiện đại được làm từ gỗ sồi tự nhiên, mang lại cảm giác gần gũi và ấm áp cho không gian phòng ngủ. Với thiết kế đơn giản nhưng không kém phần tinh tế, giường phù hợp với những ai yêu thích phong cách nội thất hiện đại, tối giản. Bề mặt gỗ được phủ lớp sơn PU cao cấp, chống thấm nước và chống trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, mang lại sự thoải mái tối đa cho giấc ngủ. Sản phẩm này là lựa chọn lý tưởng cho các căn hộ hoặc nhà phố hiện đại.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên phong cách Bắc Âu được làm từ gỗ thông nhập khẩu, mang lại vẻ đẹp mộc mạc nhưng không kém phần hiện đại. Thiết kế giường nhấn mạnh vào sự tối giản, với các đường nét thanh thoát và màu gỗ sáng tự nhiên. Bề mặt gỗ được xử lý kỹ lưỡng, phủ lớp sơn PU chống ẩm và chống trầy xước, đảm bảo độ bền lâu dài trong mọi điều kiện thời tiết. Kích thước giường rộng rãi, phù hợp cho các phòng ngủ có diện tích vừa và lớn. Sản phẩm này là sự lựa chọn hoàn hảo cho những ai yêu thích phong cách Scandinavian.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên cổ điển được chế tác từ gỗ óc chó cao cấp, mang lại vẻ đẹp sang trọng và đẳng cấp cho không gian phòng ngủ. Với thiết kế cổ điển, giường có các chi tiết chạm khắc tinh xảo, tạo nên sự khác biệt và nổi bật. Bề mặt gỗ được phủ lớp sơn PU cao cấp, chống thấm nước, chống mối mọt và chống trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, mang lại sự thoải mái tối đa cho giấc ngủ. Sản phẩm này là lựa chọn lý tưởng cho những ai yêu thích phong cách nội thất cổ điển và sang trọng.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên sang trọng tối giản được làm từ gỗ sồi tự nhiên, mang lại cảm giác gần gũi và ấm áp cho không gian phòng ngủ. Với thiết kế đơn giản nhưng không kém phần tinh tế, giường phù hợp với những ai yêu thích phong cách nội thất hiện đại, tối giản. Bề mặt gỗ được phủ lớp sơn PU cao cấp, chống thấm nước và chống trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, mang lại sự thoải mái tối đa cho giấc ngủ. Sản phẩm này là lựa chọn lý tưởng cho các căn hộ hoặc nhà phố hiện đại.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên tinh tế được chế tác từ gỗ sồi tự nhiên, mang lại vẻ đẹp hiện đại và sang trọng cho không gian phòng ngủ. Thiết kế giường đơn giản nhưng tinh tế, với các đường nét mạnh mẽ và bề mặt gỗ mịn màng. Lớp phủ sơn PU cao cấp giúp bảo vệ gỗ khỏi ẩm mốc, mối mọt và trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, phù hợp cho các cặp đôi hoặc những ai yêu thích không gian ngủ thoải mái. Sản phẩm này là sự kết hợp hoàn hảo giữa thẩm mỹ và công năng, nâng tầm không gian sống.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên cao cấp được làm từ gỗ óc chó nhập khẩu, mang lại vẻ đẹp sang trọng và đẳng cấp cho phòng ngủ. Thiết kế giường hiện đại, với các đường nét mềm mại và bề mặt gỗ mịn màng. Lớp phủ sơn PU cao cấp giúp bảo vệ gỗ khỏi ẩm mốc, mối mọt và trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, phù hợp cho các cặp đôi hoặc những ai yêu thích không gian ngủ thoải mái. Sản phẩm này là sự kết hợp hoàn hảo giữa thẩm mỹ và công năng, nâng tầm không gian sống.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên phong cách Nhật Bản được làm từ gỗ thông nhập khẩu, mang lại vẻ đẹp mộc mạc và thanh lịch. Thiết kế giường thấp, tối giản, với các đường nét thanh thoát, phù hợp với những ai yêu thích phong cách Zen và sự yên bình. Bề mặt gỗ được xử lý kỹ lưỡng, phủ lớp sơn PU chống ẩm và chống trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, phù hợp cho các phòng ngủ có diện tích vừa và lớn. Sản phẩm này mang lại cảm giác thư giãn và thoải mái, lý tưởng cho giấc ngủ chất lượng.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên tối giản được làm từ gỗ sồi tự nhiên, mang lại cảm giác gần gũi và ấm áp cho không gian phòng ngủ. Với thiết kế đơn giản nhưng không kém phần tinh tế, giường phù hợp với những ai yêu thích phong cách nội thất hiện đại, tối giản. Bề mặt gỗ được phủ lớp sơn PU cao cấp, chống thấm nước và chống trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, mang lại sự thoải mái tối đa cho giấc ngủ. Sản phẩm này là lựa chọn lý tưởng cho các căn hộ hoặc nhà phố hiện đại.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên sang trọng được chế tác từ gỗ óc chó nhập khẩu, mang lại vẻ đẹp đẳng cấp và tinh tế cho phòng ngủ. Với thiết kế hiện đại, giường có các đường nét mềm mại và bề mặt gỗ được xử lý mịn màng. Lớp phủ sơn PU cao cấp giúp bảo vệ gỗ khỏi ẩm mốc, mối mọt và trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, phù hợp cho các phòng ngủ lớn, mang lại sự thoải mái tối đa cho giấc ngủ. Sản phẩm này là lựa chọn lý tưởng cho những ai yêu thích sự sang trọng và chất lượng cao.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên hiện đại được làm từ gỗ sồi tự nhiên, mang lại vẻ đẹp tinh tế và sang trọng cho không gian phòng ngủ. Thiết kế giường đơn giản nhưng hiện đại, với các đường nét mạnh mẽ và bề mặt gỗ mịn màng. Lớp phủ sơn PU cao cấp giúp bảo vệ gỗ khỏi ẩm mốc, mối mọt và trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, phù hợp cho các cặp đôi hoặc những ai yêu thích không gian ngủ thoải mái. Sản phẩm này là sự kết hợp hoàn hảo giữa thẩm mỹ và công năng, nâng tầm không gian sống.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    ...
    },
    {
      ...
      category: 'Giường Ngủ',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên tối giản được chế tác từ gỗ sồi tự nhiên, mang lại cảm giác gần gũi và ấm áp cho không gian phòng ngủ. Với thiết kế đơn giản nhưng không kém phần tinh tế, giường phù hợp với những ai yêu thích phong cách nội thất hiện đại, tối giản. Bề mặt gỗ được phủ lớp sơn PU cao cấp, chống thấm nước và chống trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, mang lại sự thoải mái tối đa cho giấc ngủ. Sản phẩm này là lựa chọn lý tưởng cho các căn hộ hoặc nhà phố hiện đại.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      category: 'Tủ Quần Áo',
      image: 'images/products/product8.png',
      description: 'Giường ngủ gỗ tự nhiên cao cấp được làm từ gỗ óc chó nhập khẩu, mang lại vẻ đẹp sang trọng và đẳng cấp cho phòng ngủ. Thiết kế giường tối giản nhưng tinh tế, với các đường nét mềm mại và bề mặt gỗ được xử lý mịn màng. Lớp phủ sơn PU cao cấp giúp bảo vệ gỗ khỏi ẩm mốc, mối mọt và trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, phù hợp cho các cặp đôi hoặc những ai yêu thích không gian ngủ thoải mái. Sản phẩm này là sự kết hợp hoàn hảo giữa thẩm mỹ và công năng, nâng tầm không gian sống.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      image: 'images/products/product8.png',
      featured: true,
      description: 'Giường ngủ gỗ tự nhiên được chế tác từ gỗ sồi cao cấp, mang lại vẻ đẹp sang trọng và độ bền vượt trội. Với thiết kế hiện đại, giường có các đường nét tinh tế, phù hợp với nhiều phong cách nội thất từ cổ điển đến hiện đại. Bề mặt gỗ được xử lý kỹ lưỡng, phủ lớp sơn PU chống thấm nước và chống trầy xước, đảm bảo độ bền lâu dài. Kích thước giường rộng rãi, mang lại sự thoải mái tối đa cho giấc ngủ. Sản phẩm này là lựa chọn lý tưởng cho những ai yêu thích sự tinh tế và chất lượng cao trong không gian phòng ngủ.',
      size: '180x200cm',
      gallery: [
        'images/products/product8.png'
      ],
    },
    {
      ...
      image: 'images/products/product7.png',
      featured: true,
      description: 'Tủ sách đa năng được thiết kế để đáp ứng nhu cầu lưu trữ và trang trí trong không gian sống hiện đại. Sản phẩm được làm từ gỗ MDF phủ melamine vân gỗ óc chó sang trọng, mang lại độ bền cao và khả năng chống ẩm, chống mối mọt hiệu quả. Với các kệ mở và ngăn kéo tích hợp, tủ phù hợp để lưu trữ sách, tài liệu, đồ trang trí hoặc các vật dụng cá nhân. Thiết kế tinh tế, tối ưu không gian, giúp tủ dễ dàng phù hợp với phòng khách, phòng làm việc hoặc phòng ngủ. Kích thước lớn nhưng vẫn gọn gàng, lý tưởng cho nhiều phong cách nội thất.',
      size: '100x30x180cm',
    ...
    },
    {
      ...
      reviewCode: 'NTBV2026',
      featured: true,
      description: 'Bàn học QA84 được thiết kế dành riêng cho học sinh và sinh viên với phong cách tối giản nhưng đầy đủ công năng. Sản phẩm được làm từ gỗ tự nhiên phủ sơn PU cao cấp, mang lại độ bền vượt trội và khả năng chống trầy xước. Thiết kế gồm 2 cánh dài, 1 cánh ngắn và 2 ngăn kéo tiện lợi, giúp lưu trữ sách vở, tài liệu và dụng cụ học tập một cách ngăn nắp. Màu vân gỗ sồi tự nhiên tạo cảm giác ấm áp, kích thích sự tập trung khi học tập. Kích thước bàn phù hợp với các phòng học nhỏ, đảm bảo sự thoải mái khi sử dụng trong thời gian dài.',
      size: '100x50x75cm',
      warranty: '10 năm',
      price: 'Liên hệ',
      ...
      views: 1560,
      soldCount: 120,
      promoEndDate: '2025-04-30T00:00:00',
      flashsale: {
        active: true,
        discountPercent: 25,
        oldPrice: 2500000,
    ...
    },
    {
      ...
      views: 980,
      soldCount: 42,
      promoEndDate: '2025-05-15T00:00:00',
      sku: 'NTBV-TB120',
      gallery: [
        'images/products/product2.png',
        'images/products/product2.png'
    ...
    },
    {
      ...
      views: 1250,
      soldCount: 120,
      promoEndDate: '2025-05-30T00:00:00',
      sku: 'NTBV-QA205',
      flashsale: {
        active: true,
        discountPercent: 30,
