const products = [
  {
    ...
    detailedDescription: {
      ...
      </ul><div style="text-align: center;"><img src="images/products/product1.png"></div><div style="text-align: center;"><i>ảnh thực tế thi công của nội thất bàng vũ</i></div><div style="text-align: center;"><br></div><div style="text-align: left;"><p>Tủ quần áo QA205 là sự lựa chọn hoàn hảo cho không gian phòng ngủ hiện đại với thiết kế sang trọng và công năng vượt trội.</p><p>Được chế tác từ gỗ MDF phủ melamine cao cấp với vân gỗ óc chó ấm áp, sản phẩm không chỉ mang đến vẻ đẹp thẩm mỹ mà còn đảm bảo độ bền vượt trội theo thời gian.</p><h4>Đặc điểm nổi bật:</h4><ul><li>Thiết kế 4 cánh mở rộng rãi, tạo không gian lưu trữ tối đa</li><li>2 hàng ngăn kéo tiện lợi cho việc sắp xếp đồ lót, phụ kiện</li><li>Ô hở bên trái tiện dụng để trưng bày hoặc để đồ thường xuyên sử dụng</li><li>Chất liệu nhựa Đài Loan bền chắc, chống ẩm mốc, chống cong vênh</li><li>Màu vân óc chó sang trọng, dễ dàng kết hợp với nhiều phong cách nội thất</li></ul><div><br></div><div><div style="text-align: center;"><img src="http://127.0.0.1:5500/admin/images/products/product1.png"></div><div style="text-align: center;"><i>ảnh thực tế thi công của nội thất bàng vũ</i></div></div></div>`,
      images: [
        {
        ...
        replies: [
          {
            ...
            content: `Cảm ơn anh đã tin tưởng và ủng hộ sản phẩm của chúng tôi. Chúc anh và gia đình có trải nghiệm tuyệt vời với sản phẩm!nnnnnn`,
          },
        ],
      },
      {
